...
public class Esercizioprof1 {
    ...
    /*public static int SommaNumero(int m[][], int n){
        int somma= 0;
        for (int j = 0 ; j < 3 ; j++){
            somma = somma + m[n][j];
        }
    ...
    public static int SommaNumeroCollo(int m[][], int n){
        int somma= 0;
        for (int i = 0 ; i < 3 ; i++){
            somma = somma + m[i][n];
        }
    ...
    public static void main(String[] args) {
        ...
        n = sc.nextInt();
        int sommarig;
        sommarig = SommaNumero(matrice, n);
        System.out.println(sommarig);
        int sommacol;
        sommacol = SommaNumeroCollo(matrice, n);
        System.out.println(sommacol);*/
